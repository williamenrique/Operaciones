...
document.addEventListener('DOMContentLoaded', function () {
	...
	/**********cargar historia en la tabla**********/
	if(document.querySelector("#tableHistoria")){
		$("#tableHistoria").DataTable({
			...
			"ajax": {
				"url": ' ' + base_url + 'Flota/getHistoriaStatus',
				"dataSrc": ''
			},
			"columns": [
				{ 'data': 'id_unidad' },
			...
			"responsive": true, "lengthChange": true, "autoWidth": false,
			"buttons": ["copy", "csv", "excel", "pdf", "print"]
		}).buttons().container().appendTo('#tableHistoria_wrapper .col-sm-6:eq(0)')
	}
})
...
if (document.querySelector('#txtKilometraje')) {
}
